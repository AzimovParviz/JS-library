...
export const usersSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(signIn.fulfilled, (state: UsersState, action) => {
    ...
    builder.addCase(borrowBooksThunk.pending, (state: UsersState) => {});
    builder.addCase(borrowBooksThunk.fulfilled, (state: UsersState, action) => {
      console.log("book borrowed to user");
    });
    builder.addCase(returnBooksThunk.pending, () => {});
    builder.addCase(returnBooksThunk.fulfilled, () => {
